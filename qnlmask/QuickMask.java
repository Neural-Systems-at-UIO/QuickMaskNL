			...
			public void actionPerformed(ActionEvent ae) {
				try {
					...
					if (series.slices.size() < 1) {
						JOptionPane.showMessageDialog(null, "Error", f.getName() + " is not compatible with VisuAlign.",
					...
					for (Slice slice : series.slices) {
						...
						FileOutputStream fos = new FileOutputStream(dir.getText() + File.separator
